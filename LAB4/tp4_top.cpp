...
#define SEG_TIM_SIZE    16

#define SEG_IOC_BASE    0x92000000
#define SEG_IOC_SIZE    32

#define SEG_DMA_BASE    0x93000000
#define SEG_DMA_SIZE    32
...
int _main(int argc, char *argv[])
{
    ...
    ioc = new VciBlockDevice<vci_param>("ioc", maptab, IntTab(SRCID_IOC), IntTab(TGTID_IOC), ioc_filename ,512, 0); 
