...
int _main(int argc, char *argv[])
{
	...
	// Mapping Table
	//////////////////////////////////////////////////////////////////////////
	MappingTable maptab(32, IntTab(8),IntTab(1) , 0xFFFF0000);
	...
	proc = new VciXcacheWrapper<vci_param, Mips32ElIss>("processor", 0, maptab, IntTab(0),
	 icache_ways, icache_sets, icache_words, dcache_ways, dcache_sets, dcache_words);
	...
	tty = new VciMultiTty<vci_param>("tty", IntTab(TGTID_TTY), maptab, "term0", NULL);

	VciGcdCoprocessor<vci_param>* gcd;
	gcd = new VciGcdCoprocessor<vci_param>("gcd_coprocesor", IntTab(TGTID_GCD), maptab);
